...
import com.project.byeoryback.domain.community.service.CommunityService; // 댓글 목록 조회용
...
public class MessageController {
    ...
    private final CommunityService communityService; // 댓글 목록을 커뮤니티 ID로 조회하기 위해 필요하면 사용
